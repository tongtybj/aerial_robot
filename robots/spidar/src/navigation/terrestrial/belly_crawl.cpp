  ...
  case limb_.PHASE1:
    {
      ...
      for (int l = 0; l < limb_num; l++) {
        ...
        ROS_INFO_STREAM(prefix << " the angle error of joint" << j/2 + 1 << "_yaw does not converge, " << err << "(" << limb_.joint_err_thresh_ << "), target_angle: " << target_angle << ", current_angle: " << current_angle);
      ...
      for (int l = 0; l < limb_num; l++) {
        ...
        ROS_INFO_STREAM(prefix << " the angle error of joint" << j/2 + 2 << "_pitch does not converge, " << err << "(" << limb_.joint_err_thresh_ << "), target_angle: " << target_angle << ", current_angle: " << current_angle);
