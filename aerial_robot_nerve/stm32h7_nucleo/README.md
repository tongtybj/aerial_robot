...
Please push blue button of **one of** the boards to trigger CAN TX from this board.
Then you can see the green leds of two boards start to blink.
This means both boards receive CAN message from each other.
